...
{
    private static final String TAG = "cutag";
    ...
    public ColoredTimePicker(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            ...
            selectionDividerField.set(hourNumberPicker, getResources().getDrawable(R.color.active_red));
            selectionDividerField.set(minuteNumberPicker, getResources().getDrawable(R.color.active_red));
            selectionDividerField.set(amPmNumberPicker, getResources().getDrawable(R.color.active_red));
        }
        ...
        {
            Log.e(TAG, "NullPointerException in CustomTimePicker", e);
        }
    }
}
