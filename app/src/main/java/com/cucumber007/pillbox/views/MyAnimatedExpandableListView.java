 ...
 */
public class MyAnimatedExpandableListView extends ExpandableListView {
    /*
     ...
     * to refreshFrontView all of it's view. This time however, depending on whether a
     ...
     * ExpandableListView to refreshFrontView all views on screen. The way that
     ...
     * the ExpandableListView is forced to refreshFrontView it's views again, except this
     ...
     * 9. This forces the ExpandableListView to refreshFrontView all of it's views again.
    ...
    public MyAnimatedExpandableListView(Context context) {
        super(context);
    }

    public MyAnimatedExpandableListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MyAnimatedExpandableListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean collapseGroupWithAnimation(int groupPos) {
        ...
        // Force the listview to refreshFrontView it's views
    ...
    public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private MyAnimatedExpandableListView parent;

        private static final int STATE_IDLE = 0;
        private static final int STATE_EXPANDING = 1;
        private static final int STATE_COLLAPSING = 2;

        private void setParent(MyAnimatedExpandableListView parent) {
            this.parent = parent;
        }
        ...
        public final View getChildView(final int groupPosition, int childPosition, boolean isLastChild, View convertView, final ViewGroup parent) {
            ...
            if (info.animating) {
                ...
                dummyView.setDivider(listView.getContext().getResources().getDrawable(R.color.white), parent.getMeasuredWidth(), listView.getDividerHeight());
    ...
    private static class DummyView extends View {
        ...
        public void dispatchDraw(Canvas canvas) {
            canvas.save();
            if(divider != null) {
                divider.setBounds(0, canvas.getHeight()-dividerHeight, dividerWidth, canvas.getHeight());
            }
